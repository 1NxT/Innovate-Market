...
class Principal():
    ...
    def elementos(self):
        ...
        self.lbl_dadosUsuario = Label(
            self.tk, text="", bg="GhostWhite", font="Arial 18", fg="red")
        self.lbl_dadosUsuario.place(x=720, y=330)

        self.lbl_dadosSenha = Label(
            self.tk, text="", bg="GhostWhite", font="Arial 18", fg="red")
        ...
        self.__buttonEntrarImagem = PhotoImage(
            file=self.__buttonEntrarImagemPath)
        self.btn_entrar = Button(
            self.tk, text="Entrar",  image=self.__buttonEntrarImagem, command=self.chamarLogar, borderwidth=0)
        ...
        self.btn_sair = Button(
            self.tk, text="Sair", image=self.__buttonSairImagem, command=self.iExit, borderwidth=0)
