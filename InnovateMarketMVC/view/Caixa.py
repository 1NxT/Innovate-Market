...
class Caixa(Frame):
    ...
    def elementos(self):
        ...
        self.tree_caixa.heading('#1', text="Codigo", anchor=CENTER)
        self.tree_caixa.heading('#2', text="Descricao", anchor=CENTER)
        self.tree_caixa.heading('#3', text="Qtde", anchor=CENTER)
        self.tree_caixa.heading('#4', text="Total", anchor=CENTER)
        self.view_tree()
        # Menu de opções
